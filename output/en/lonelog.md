...
creates consistency—every resolution gets the same declaration, making
your log easier to scan and parse. Whether you rolled dice or asked the
oracle, `->` marks the moment uncertainty becomes certainty.
